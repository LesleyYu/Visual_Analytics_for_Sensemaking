...
!(function (t, e) {
  function n(t, n) {
    ...
    function l(t, e) {
      (x.tables[t] = { fields: e, auto_increment: 1 }), (x.data[t] = {});
    }
    function s(t) {
    ...
    function d(t, e, n) {
      if (
        ((x.tables[t].fields = x.tables[t].fields.concat(e)),
        "undefined" != typeof n)
      )
        for (var r in x.data[t])
          if (x.data[t].hasOwnProperty(r))
            for (var a in e)
              x.data[t][r][e[a]] = "object" == typeof n ? n[e[a]] : n;
    }
    function h(t) {
      var e = 0;
    ...
    function v(t, e) {
      return (
        (e.ID = x.tables[t].auto_increment),
        (x.data[t][x.tables[t].auto_increment] = e),
        x.tables[t].auto_increment++,
        e.ID
      );
    }
    function p(t, n, r, a, i, o) {
      for (var f = null, u = [], l = null, s = 0; s < n.length; s++)
        (f = n[s]), (l = x.data[t][f]), u.push(k(l));
      if (i && i instanceof Array)
        for (var s = 0; s < i.length; s++)
          u.sort(y(i[s][0], i[s].length > 1 ? i[s][1] : null));
      if (o && o instanceof Array) {
        for (var c = 0; c < o.length; c++)
          for (var d = {}, h = o[c], s = 0; s < u.length; s++)
            u[s] !== e &&
              (u[s].hasOwnProperty(h) && d.hasOwnProperty(u[s][h])
                ? delete u[s]
                : (d[u[s][h]] = 1));
      ...
      return (
        (r = r && "number" == typeof r ? r : null),
        (a = a && "number" == typeof a ? a : null),
        r && a
          ? (u = u.slice(r, r + a))
          : r
          ? (u = u.slice(r))
          ...
          for (var o in e)
            if (e.hasOwnProperty(o))
              if ("string" == typeof e[o]) {
                if (
                  a[o].toString().toLowerCase() != e[o].toString().toLowerCase()
                ) {
                  r = !1;
                  break;
                }
    ...
    function g(t, e) {
      var n = [],
        r = null;
      for (var a in x.data[t])
        x.data[t].hasOwnProperty(a) &&
          ((r = x.data[t][a]), 1 == e(k(r)) && n.push(a));
      return n;
    }
    function m(t) {
      var e = [];
    ...
    function w(t, e) {
      for (var n = 0; n < e.length; n++)
        x.data[t].hasOwnProperty(e[n]) && delete x.data[t][e[n]];
      return e.length;
    }
    function O(t, e, n) {
    ...
    function j(t, n) {
      for (var r = "", a = {}, i = 0; i < x.tables[t].fields.length; i++)
        (r = x.tables[t].fields[i]), n[r] !== e && (a[r] = n[r]);
      return a;
    }
    function I(t, n) {
      for (var r = "", a = {}, i = 0; i < x.tables[t].fields.length; i++)
        (r = x.tables[t].fields[i]),
          (a[r] = null === n[r] || n[r] === e ? null : n[r]);
      return a;
    }
    var C = "db_",
      _ = C + t,
    ...
    return (
      (x = E[_]),
      (x && (x = JSON.parse(x)) && x.tables && x.data) ||
        (T(t)
          ? ((x = { tables: {}, data: {} }), P(), (q = !0))
          : D("The name '" + t + "' contains invalid characters")),
      {
        commit: function () {
          return P();
        },
        ...
        createTable: function (t, e) {
          ...
          if (T(t))
            if (this.tableExists(t))
              D("The table name '" + t + "' already exists.");
            else {
        ...
        createTableWithData: function (t, e) {
          ("object" != typeof e || !e.length || e.length < 1) &&
            D(
          ...
          if (this.createTable(t, n)) {
            ...
            for (var r = 0; r < e.length; r++)
              v(t, e[r]) ||
                D("Failed to insert record: [" + JSON.stringify(e[r]) + "]");
            this.commit();
          }
          return !0;
        },
        ...
        queryAll: function (t, e) {
          return e
            ? this.query(
                t,
                e.hasOwnProperty("query") ? e.query : null,
                e.hasOwnProperty("limit") ? e.limit : null,
                e.hasOwnProperty("start") ? e.start : null,
                e.hasOwnProperty("sort") ? e.sort : null,
                e.hasOwnProperty("distinct") ? e.distinct : null
              )
            : this.query(t);
        },
